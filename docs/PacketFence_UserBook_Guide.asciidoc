...
////
    ...
    See PacketFence_UserBook_Guide-docinfo.xml for authors, copyright
...
We also advise to configure a SSID for provisioning, for instance: `OnBoarding-PF`, open with MAC Authentication, pointing to PacketFence. Add a filter SSID with this SSID name and add your provisioners to this new Portal Profile. From there users who logged in while have to follow the captive portal instruction to get provided.
